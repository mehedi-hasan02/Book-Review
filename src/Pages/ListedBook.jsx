    ...
    return (
        <div className="">
            ...
            <div className="flex  -mx-4 overflow-x-auto overflow-y-hidden flex-nowrap  dark:text-gray-800">
                ...
                rel="noopener noreferrer"  className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tabIndex === 1 ? 'border border-b-0' : 'border-b w-full'} rounded-t-lg dark:border-gray-600 dark:text-gray-900`}>
